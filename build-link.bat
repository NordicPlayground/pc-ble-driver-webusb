emcmake cmake && ^
mingw32-make -s BINARYEN_TRAP_MODE='js' && ^
...
--post-js src/js/bindings/bleEvtStruct.js --post-js src/js/bindings/emscripten.js --post-js src/js/gattc.js --post-js src/js/bindings/bleSDAttributeStructs.js ^
