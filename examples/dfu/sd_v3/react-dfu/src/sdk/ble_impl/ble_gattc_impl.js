...
export const sd_ble_gattc_primary_services_discover = async (adapter, conn_handle, start_handle, p_srvc_uuid) => {
...
export const sd_ble_gattc_relationships_discover  = async (adapter, conn_handle, p_handle_range) => {
...
export const sd_ble_gattc_characteristics_discover = async (adapter, conn_handle, p_handle_range) => {
...
export const sd_ble_gattc_descriptors_discover = async (adapter, conn_handle, p_handle_range) => {
...
export const sd_ble_gattc_char_value_by_uuid_read = async (adapter, conn_handle, p_uuid, p_handle_range) => {
...
export const sd_ble_gattc_read = async (adapter, conn_handle, handle, offset) => {
...
export const sd_ble_gattc_char_values_read = async (adapter, conn_handle, p_handles, handle_count) => {
...
export const sd_ble_gattc_write = async (adapter, conn_handle, p_write_params) => {
...
export const sd_ble_gattc_hv_confirm = async (adapter, conn_handle, handle) => {
...
export const sd_ble_gattc_attr_info_discover = async (adapter, conn_handle, p_handle_range) => {
...
export let sd_ble_gattc_exchange_mtu_request;
