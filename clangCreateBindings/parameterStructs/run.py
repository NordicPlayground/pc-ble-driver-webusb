from clangCreateBindings.parameterStructs.clangParse import parseAll, pc_ble_drive_webusb_root, headers
...
with open(pc_ble_drive_webusb_root+"\\src\\sd_api_v3\\bindings\\ble_attr_structs.cpp", "w") as file:
    file.write(cppSource)
    print("Wrote {}\\src\\sd_api_v3\\bindings\\ble_attr_structs.cpp".format(pc_ble_drive_webusb_root))
