...
const { NRF_ERROR_INVALID_PARAM } = require('../sd_rpc_types');
const { NRF_SD_BLE_API_VERSION } = require('../bindings/version');

module.exports.sd_ble_uuid_encode = async (adapter, p_uuid, p_uuid_le_len, p_uuid_le) => {
...
if (NRF_SD_BLE_API_VERSION < 4) {
    module.exports.sd_ble_tx_packet_count_get = async (adapter, conn_handle, p_count) => {
...
module.exports.sd_ble_uuid_vs_add = async (adapter, p_vs_uuid, p_uuid_type) => {
...
module.exports.sd_ble_uuid_decode = async (adapter, uuid_le_len, p_uuid_le, p_uuid) => {
...
module.exports.sd_ble_version_get = async (adapter, p_version) => {
...
module.exports.sd_ble_opt_get = async (adapter, opt_id, p_opt) => {
...
module.exports.sd_ble_opt_set = async (adapter, opt_id, p_opt) => {
...
if (NRF_SD_BLE_API_VERSION >= 5) {
    module.exports.sd_ble_cfg_set = async (adapter, cfg_id, p_cfg, app_ram_base) => {
...
//let sd_ble_enable;
if (NRF_SD_BLE_API_VERSION < 4) {
    module.exports.sd_ble_enable = async (adapter, p_params, p_app_ram_base) => {
    ...
    module.exports.sd_ble_enable = async (adapter, p_app_ram_base) => {
...
module.exports.sd_ble_user_mem_reply = async (adapter, conn_handle, p_block) => {
    if (p_block !== null) {
