const sd_ble_gattc_primary_services_discover = async (adapter, conn_handle, start_handle, p_srvc_uuid) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_primary_services_discover_req_enc(conn_handle, start_handle, p_srvc_uuid, buffer, length);
...
const sd_ble_gattc_relationships_discover  = async (adapter, conn_handle, p_handle_range) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_relationships_discover_req_enc(conn_handle, p_handle_range, buffer, length);
...
const sd_ble_gattc_characteristics_discover = async (adapter, conn_handle, p_handle_range) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_characteristics_discover_req_enc(conn_handle, p_handle_range, buffer, length);
...
const sd_ble_gattc_descriptors_discover = async (adapter, conn_handle, p_handle_range) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_descriptors_discover_req_enc(conn_handle, p_handle_range, buffer, length);
...
const sd_ble_gattc_char_value_by_uuid_read = async (adapter, conn_handle, p_uuid, p_handle_range) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_char_value_by_uuid_read_req_enc(conn_handle, p_uuid, p_handle_range, buffer, length);
...
const sd_ble_gattc_read = async (adapter, conn_handle, handle, offset) => {
...
const sd_ble_gattc_char_values_read = async (adapter, conn_handle, p_handles, handle_count) => {
...
const sd_ble_gattc_write = async (adapter, conn_handle, p_write_params) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_write_req_enc(conn_handle, p_write_params, buffer, length);
    const decode_function = (buffer, length, result) => emscriptenBindings.ble_gattc_write_rsp_dec(buffer, length, result);
    return encode_decode(adapter, encode_function, decode_function);
};
const sd_ble_gattc_hv_confirm = async (adapter, conn_handle, handle) => {
...
const sd_ble_gattc_attr_info_discover = async (adapter, conn_handle, p_handle_range) => {
    const encode_function = (buffer, length) => emscriptenBindings.ble_gattc_attr_info_discover_req_enc(conn_handle, p_handle_range, buffer, length);
