...
pc_ble_drive_root+"\\include\\common\\internal",pc_ble_drive_root+"\\include\\common\\internal\\transport"]
...
with open(pc_ble_drive_webusb_root+"\\src\\sd_api_v3\\bindings\\emscripten_bindings.cpp", "w") as file:
